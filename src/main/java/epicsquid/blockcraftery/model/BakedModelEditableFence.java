...
public class BakedModelEditableFence extends BakedModelEditable {
	...
	public BakedModelEditableFence(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter,
		...
		this.baked_post_right = makePostCube(format, 0, 0, 0.375, 0.25, 1, 0.25, null, texes, 0);
		this.baked_post_left = makePostCube(format, 0.75, 0, 0.375, 0.25, 1, 0.25, null, texes, 0);
		this.baked_west = ModelUtil.makeCube(format, 0, 0.375, 0.4375, 1, 0.1875, 0.125, null, texes, 0);
		this.baked_west_top = ModelUtil.makeCube(format, 0, 0.75, 0.4375, 1, 0.1875, 0.125, null, texes, 0);
	}
	...
	public void addGeometry(List<BakedQuad> quads, EnumFacing side, IBlockState state, TextureAtlasSprite[] texes, int tintIndex) {
		...
		post = makePostCube(this.format, 0.375, 0, 0.375, 0.25, 1, 0.25, null, texes, tintIndex);
		north = ModelUtil.makeCube(this.format, 0.4375, 0.375, 0, 0.125, 0.1875, 0.375, null, texes, tintIndex);
		south = ModelUtil.makeCube(this.format, 0.4375, 0.375, 0.625, 0.125, 0.1875, 0.375, null, texes, tintIndex);
		west = ModelUtil.makeCube(this.format, 0, 0.375, 0.4375, 0.375, 0.1875, 0.125, null, texes, tintIndex);
		east = ModelUtil.makeCube(this.format, 0.625, 0.375, 0.4375, 0.375, 0.1875, 0.125, null, texes, tintIndex);

		north_top = ModelUtil.makeCube(this.format, 0.4375, 0.75, 0, 0.125, 0.1875, 0.375, null, texes, tintIndex);
		south_top = ModelUtil.makeCube(this.format, 0.4375, 0.75, 0.625, 0.125, 0.1875, 0.375, null, texes, tintIndex);
		west_top = ModelUtil.makeCube(this.format, 0, 0.75, 0.4375, 0.375, 0.1875, 0.125, null, texes, tintIndex);
		east_top = ModelUtil.makeCube(this.format, 0.625, 0.75, 0.4375, 0.375, 0.1875, 0.125, null, texes, tintIndex);
	...
	public void addItemModel(List<BakedQuad> quads, EnumFacing side) {
		this.baked_post_right.addToList(quads, side);
		this.baked_post_left.addToList(quads, side);
		this.baked_west.addToList(quads, side);
		this.baked_west_top.addToList(quads, side);
	}
