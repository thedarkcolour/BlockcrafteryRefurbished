...
public class BakedModelEditableStairs extends BakedModelEditable {
	...
	public BakedModelEditableStairs(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter,
		...
		this.baked_cube_down = ModelUtil.makeCube(format, 0, 0, 0, 1, 0.5, 1, null, texes, 0);
		this.baked_q_up_pz = ModelUtil.makeCube(format, 0, 0.5, 0.5, 1, 0.5, 0.5, null, texes, 0);
	}
	...
	public void addGeometry(List<BakedQuad> quads, EnumFacing side, IBlockState state, TextureAtlasSprite[] texes, int tintIndex) {
		...
		cube_down = ModelUtil.makeCube(this.format, 0, 0.5, 0, 1, 0.5, 1, null, texes, new Function<Vec3d, Vec3d>() {
			@Override
			public Vec3d apply(Vec3d arg0) {
				return arg0.add(0, -0.5, 0);
			}
		}, tintIndex);
		cube_up = ModelUtil.makeCube(this.format, 0, 0.5, 0, 1, 0.5, 1, null, texes, tintIndex);
		q_up_nx = ModelUtil.makeCube(this.format, 0, 0.5, 0, 0.5, 0.5, 1, null, texes, tintIndex);
		q_up_px = ModelUtil.makeCube(this.format, 0.5, 0.5, 0, 0.5, 0.5, 1, null, texes, tintIndex);
		q_up_nz = ModelUtil.makeCube(this.format, 0, 0.5, 0, 1, 0.5, 0.5, null, texes, tintIndex);
		q_up_pz = ModelUtil.makeCube(this.format, 0, 0.5, 0.5, 1, 0.5, 0.5, null, texes, tintIndex);
		q_down_nx = ModelUtil.makeCube(this.format, 0, 0, 0, 0.5, 0.5, 1, null, texes, tintIndex);
		q_down_px = ModelUtil.makeCube(this.format, 0.5, 0, 0, 0.5, 0.5, 1, null, texes, tintIndex);
		q_down_nz = ModelUtil.makeCube(this.format, 0, 0, 0, 1, 0.5, 0.5, null, texes, tintIndex);
		q_down_pz = ModelUtil.makeCube(this.format, 0, 0, 0.5, 1, 0.5, 0.5, null, texes, tintIndex);
		e_up_nxnz = ModelUtil.makeCube(this.format, 0, 0.5, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_up_pxnz = ModelUtil.makeCube(this.format, 0.5, 0.5, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_up_pxpz = ModelUtil.makeCube(this.format, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_up_nxpz = ModelUtil.makeCube(this.format, 0, 0.5, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_down_nxnz = ModelUtil.makeCube(this.format, 0, 0, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_down_pxnz = ModelUtil.makeCube(this.format, 0.5, 0, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_down_pxpz = ModelUtil.makeCube(this.format, 0.5, 0, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
		e_down_nxpz = ModelUtil.makeCube(this.format, 0, 0, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
		c_down_nxnz = ModelUtil.makeCube(this.format, 0, 0, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		c_down_pxnz = ModelUtil.makeCube(this.format, 0.5, 0, 0, 0.5, 0.5, 0.5, null, texes, tintIndex);
		c_down_pxpz = ModelUtil.makeCube(this.format, 0.5, 0, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
		c_down_nxpz = ModelUtil.makeCube(this.format, 0, 0, 0.5, 0.5, 0.5, 0.5, null, texes, tintIndex);
	...
	public void addItemModel(List<BakedQuad> quads, EnumFacing side) {
		this.baked_cube_down.addToList(quads, side);
		this.baked_q_up_pz.addToList(quads, side);
	}
